                    ...
                    <c:forEach items="${purchaseOrderGroupList}" var="purchaseOrderGroup">
                        <a href="<c:url value='/group/joinGroup.do'/>?groupProductId=${purchaseOrderGroup.myGroup.groupProduct.id}&groupId=${purchaseOrderGroup.myGroup.id}&memberId=${purchaseOrderGroup.groupMember.id}">
                            <li>
                                ...
                                <div class="center ae">
                                    <div class="pic"><a
                                            href="<c:url value="/product/groupProduct/${purchaseOrderGroup.myGroup.groupProduct.id}"/>"><img
                                            src="http://pro.efeiyi.com/${purchaseOrderGroup.purchaseOrder.purchaseOrderProductList.get(0).productModel.productModel_url}@!group-mobile-picture-list"></a>
                                    </div>
                    ...
                    <c:forEach items="${purchaseOrderGroupList5}" var="purchaseOrderGroup5">
                        <a href="<c:url value='/group/joinGroup.do'/>?groupProductId=${purchaseOrderGroup5.myGroup.groupProduct.id}&groupId=${purchaseOrderGroup5.myGroup.id}&memberId=${purchaseOrderGroup5.groupMember.id}">
                            <li>
                                ...
                                <div class="center ae">
                                    <div class="pic"><a
                                            href="<c:url value="/product/groupProduct/${purchaseOrderGroup5.myGroup.groupProduct.id}"/>"><img
                                            src="http://pro.efeiyi.com/${purchaseOrderGroup5.purchaseOrder.purchaseOrderProductList.get(0).productModel.productModel_url}@!group-mobile-picture-list"></a>
                                    </div>
                ...
                <c:forEach items="${purchaseOrderGroupList7}" var="purchaseOrderGroup7">
                    <a href="<c:url value='/group/joinGroup.do'/>?groupProductId=${purchaseOrderGroup7.myGroup.groupProduct.id}&groupId=${purchaseOrderGroup7.myGroup.id}&memberId=${purchaseOrderGroup7.groupMember.id}">
                        <li>
                            ...
                            <div class="center ae">
                                <div class="pic"><a
                                        href="<c:url value="/product/groupProduct/${purchaseOrderGroup7.myGroup.groupProduct.id}"/>"><img
                                        src="http://pro.efeiyi.com/${purchaseOrderGroup7.purchaseOrder.purchaseOrderProductList.get(0).productModel.productModel_url}@!group-mobile-picture-list"></a>
                                </div>
                    ...
                    <c:forEach items="${purchaseOrderGroupList9}" var="purchaseOrderGroup9">
                        <a href="<c:url value='/group/joinGroup.do'/>?groupProductId=${purchaseOrderGroup9.myGroup.groupProduct.id}&groupId=${purchaseOrderGroup9.myGroup.id}&memberId=${purchaseOrderGroup9.groupMember.id}">
                            <li>
                                ...
                                <div class="center ae">
                                    <div class="pic"><a
                                            href="<c:url value="/product/groupProduct/${purchaseOrderGroup9.myGroup.groupProduct.id}"/>"><img
                                            src="http://pro.efeiyi.com/${purchaseOrderGroup9.purchaseOrder.purchaseOrderProductList.get(0).productModel.productModel_url}@!group-mobile-picture-list"></a>
                                    </div>
