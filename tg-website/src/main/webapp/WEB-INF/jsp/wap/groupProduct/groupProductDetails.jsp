...
<div class="my-colonel ae">
                ...
                <ul class="am-slides"
                    ...
                    <li class="clone c-page" aria-hidden="true" style="width: 320px; float: left; display: block;">
                        <div class="colonel-pic ae"><img
                                src="http://pro.efeiyi.com/${groupProduct.productModel.productModel_url}@!wap-product-pic">

                            <div class="c-page">
                                <span>${groupProduct.productModel.product.name}[${groupProduct.productModel.name}]</span>
                            </div>
                        </div>
                    </li>
    ...
    <div class="iwill ae">
        <div class="page ae">
            <div class="left"><p>${groupProduct.memberAmount}人起成团</p></div>
            <div class="right"><p>成团时间${groupProduct.groupPurchaseTime}天</p></div>
        </div>
            ...
            <div class="co-page">
                <div class="introduce ae">
                    ...
                    <div class="button ae"><a
                            href="http://www.efeiyi.com/product/productModel/${groupProduct.productModel.id}"
