...
<link type="text/css" rel="stylesheet" href="<c:url value="/scripts/css/app.css?v=100"/>">
<link type="text/css" rel="stylesheet" href="<c:url value="/scripts/css/myorder.css?v=100"/>">
...
<script src="<c:url value="/scripts/js/myorder.js?v=100"/>"></script>
